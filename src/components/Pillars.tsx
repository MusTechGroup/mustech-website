      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <h2 className="font-brand text-3xl sm:text-4xl md:text-5xl font-bold text-[var(--color-primary-dark)] tracking-tight mb-6">
            Values & <span className="text-[var(--color-accent)]">Technology</span>
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="px-6 py-5 rounded-2xl bg-[var(--brand-bg)] border border-[var(--color-primary)]/20 shadow-sm flex flex-col items-center text-center">
              ...
              <span className="text-sm text-[var(--color-primary-dark)]/80 leading-relaxed">Sacred Trust. Engineering with ethical data stewardship and absolute privacy.</span>
            </div>
            <div className="px-6 py-5 rounded-2xl bg-[var(--brand-bg)] border border-[var(--color-primary)]/20 shadow-sm flex flex-col items-center text-center">
              <span className="font-brand text-xl font-bold text-[var(--color-primary-dark)] mb-2">Tijarah</span>
              <span className="text-sm text-[var(--color-primary-dark)]/80 leading-relaxed">Ethical Enterprise. Building sustainable businesses without compromising principles.</span>
            </div>
            <div className="px-6 py-5 rounded-2xl bg-[var(--brand-bg)] border border-[var(--color-primary)]/20 shadow-sm flex flex-col items-center text-center">
              <span className="font-brand text-xl font-bold text-[var(--color-primary-dark)] mb-2">Mizan</span>
              <span className="text-sm text-[var(--color-primary-dark)]/80 leading-relaxed">Balance. Creating tools that elevate habits rather than demanding endless attention.</span>
            </div>
          </div>
        </div>
